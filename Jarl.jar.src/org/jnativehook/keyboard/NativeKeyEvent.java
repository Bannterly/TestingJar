...
public class NativeKeyEvent extends NativeInputEvent {
  ...
  public static final int VC_KP_DIVIDE = 3637;
  
  public static final int VC_KP_MULTIPLY = 55;
  
  public static final int VC_KP_SUBTRACT = 74;
  
  public static final int VC_KP_EQUALS = 3597;
  
  public static final int VC_KP_ADD = 78;
  
  public static final int VC_KP_ENTER = 3612;
  
  public static final int VC_KP_SEPARATOR = 83;
  
  public static final int VC_KP_1 = 79;
  
  public static final int VC_KP_2 = 80;
  
  public static final int VC_KP_3 = 81;
  
  public static final int VC_KP_4 = 75;
  
  public static final int VC_KP_5 = 76;
  
  public static final int VC_KP_6 = 77;
  
  public static final int VC_KP_7 = 71;
  
  public static final int VC_KP_8 = 72;
  
  public static final int VC_KP_9 = 73;
  
  public static final int VC_KP_0 = 82;
  
  public static final int VC_SHIFT_L = 42;
  
  public static final int VC_SHIFT_R = 54;
  
  public static final int VC_CONTROL_L = 29;
  
  public static final int VC_CONTROL_R = 3613;
  
  public static final int VC_ALT_L = 56;
  
  public static final int VC_ALT_R = 3640;
  
  public static final int VC_META_L = 3675;
  
  public static final int VC_META_R = 3676;
  ...
  public static final int VC_KP_COMMA = 126;
  ...
  public NativeKeyEvent(int paramInt1, long paramLong, int paramInt2, int paramInt3, int paramInt4, char paramChar, int paramInt5) {
    ...
    if (paramInt1 == 2400 && (paramChar == Character.MAX_VALUE || paramInt4 != 0))
      throw new IllegalArgumentException(); 
  }
  
  public NativeKeyEvent(int paramInt1, long paramLong, int paramInt2, int paramInt3, int paramInt4, char paramChar) {
    this(paramInt1, paramLong, paramInt2, paramInt3, paramInt4, paramChar, 0);
  }
  ...
  public String paramString() {
    ...
    switch (getID()) {
      case 2401:
        stringBuilder.append("NATIVE_KEY_PRESSED");
        break;
      case 2402:
        stringBuilder.append("NATIVE_KEY_RELEASED");
        break;
      case 2400:
        stringBuilder.append("NATIVE_KEY_TYPED");
        break;
      default:
    ...
    stringBuilder.append(getKeyText(this.keyCode));
    stringBuilder.append(',');
    ...
    switch (this.keyChar) {
      ...
      case '\034':
      case '๓':
        stringBuilder.append(getKeyText(this.keyChar));
        break;
      case '￿':
        stringBuilder.append(getKeyText(0));
        break;
      default:
        stringBuilder.append('\'');
        stringBuilder.append(this.keyChar);
        stringBuilder.append('\'');
        break;
    } 
    stringBuilder.append(',');
    ...
    switch (this.keyLocation) {
      case 0:
        ...
        stringBuilder.append(',');
        stringBuilder.append("rawCode=");
        stringBuilder.append(this.rawCode);
...
/* Location:              C:\Users\danzi\Downloads\Jarl.jar!\org\jnativehook\keyboard\NativeKeyEvent.class
